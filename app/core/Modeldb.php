...
trait Model
{
    ...
    public function update($id, $data, $id_column = 'idTornado')
    {
    ...
    public function delete($id, $id_column = 'idTornado')
    {
    ...
    protected function getPrimaryKey()
    {
        ...
        return $this->primaryKey ?? 'idTornado';
    }
